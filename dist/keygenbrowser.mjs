...
import { createClient, uploadPublicKey, } from '@deephaven-enterprise/auth-nodejs';
import { authWithPrivateKey, generateBase64KeyPair, } from './utils/authUtilsBrowser.mjs';
